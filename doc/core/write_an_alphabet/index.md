...
bio::alphabet::alphabet_base for details. This implementation deduces `bool` as the smallest possible rank type.
...
With the overload of bio::alphabet::char_is_valid_for we allow assignment to the underlying boolean type
