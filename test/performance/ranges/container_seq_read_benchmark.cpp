...
BENCHMARK_TEMPLATE(sequential_read, std::vector, bio::alphabet::alphabet_variant<char, bio::alphabet::dna4>);
...
BENCHMARK_TEMPLATE(sequential_read, std::deque, bio::alphabet::alphabet_variant<char, bio::alphabet::dna4>);
...
BENCHMARK_TEMPLATE(sequential_read, small_vec, bio::alphabet::alphabet_variant<char, bio::alphabet::dna4>);
...
BENCHMARK_TEMPLATE(sequential_read, std::vector, bio::alphabet::alphabet_variant<char, bio::alphabet::dna4>, true);
...
//TODO(bio): works on gcc10, fails on gc11
// BENCHMARK_TEMPLATE(sequential_read, bio::ranges::bitcompressed_vector, bio::alphabet::alphabet_variant<char, bio::alphabet::dna4>, true);
...
BENCHMARK_TEMPLATE(sequential_read, small_vec, bio::alphabet::alphabet_variant<char, bio::alphabet::dna4>, true);
