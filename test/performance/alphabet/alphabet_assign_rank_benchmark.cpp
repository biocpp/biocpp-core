...
BENCHMARK_TEMPLATE(assign_rank, bio::alphabet::variant<bio::alphabet::gap, bio::alphabet::dna4, bio::alphabet::dna5, bio::alphabet::dna15,
                                                         bio::alphabet::rna15, bio::alphabet::rna4, bio::alphabet::rna5>);
BENCHMARK_TEMPLATE(assign_rank, bio::alphabet::variant<bio::alphabet::dna4, char>);
/* alphabet tuple */
