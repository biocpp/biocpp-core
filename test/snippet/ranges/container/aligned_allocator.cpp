...
int main()
{
    ...
    std::vector<int16_t, bio::ranges::aligned_allocator<int16_t, 128u>> vec128{1,2,3,4,5};
    ...
    std::vector<int32_t, bio::ranges::aligned_allocator<int32_t, 256u>> vec256{1,2,3,4,5};
