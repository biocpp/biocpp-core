...
{
    [[maybe_unused]] bio::meta::pod_tuple<int, long, float> t1;
}

// aggregate initialization
TEST(pod_tuple_aggr, aggr)
{
    [[maybe_unused]] bio::meta::pod_tuple<int, long, float> t1{4, 7l, 3.0f};
}

// zero initialization
TEST(pod_tuple_zro, zro)
{
    bio::meta::pod_tuple<int, long, float> t1{0, 0, 0};
...
TEST(pod_tuple_cp_ctr, cp_ctr)
{
    ...
    bio::meta::pod_tuple<int, long, float> t2{t1};
    bio::meta::pod_tuple<int, long, float> t3(t1);
    EXPECT_EQ(t1, t2);
    EXPECT_EQ(t2, t3);
}
...
{
    bio::meta::pod_tuple<int, long, float> t0{4, 6l, 4.0f};
    bio::meta::pod_tuple<int, long, float> t1{4, 7l, 3.0f};
    bio::meta::pod_tuple<int, long, float> t2{4, 7l, 4.0f};
