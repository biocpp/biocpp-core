...
{
    using bool_1_t   = bio::meta::detail::min_viable_uint_t<0ull>;
    using bool_2_t   = bio::meta::detail::min_viable_uint_t<1ull>;
    using uint8_1_t  = bio::meta::detail::min_viable_uint_t<2ull>;
    using uint8_2_t  = bio::meta::detail::min_viable_uint_t<0xFFull>;
    using uint16_1_t = bio::meta::detail::min_viable_uint_t<0x100ull>;
    using uint16_2_t = bio::meta::detail::min_viable_uint_t<0xFFFFull>;
    using uint32_1_t = bio::meta::detail::min_viable_uint_t<0x10000ull>;
    using uint32_2_t = bio::meta::detail::min_viable_uint_t<0xFFFFFFFFull>;
    using uint64_1_t = bio::meta::detail::min_viable_uint_t<0x100000000ull>;
    using uint64_2_t = bio::meta::detail::min_viable_uint_t<0xFFFFFFFFFFFFFFFFull>;

    EXPECT_TRUE((std::is_same_v<bool_1_t, uint8_t>));
    EXPECT_TRUE((std::is_same_v<bool_2_t, uint8_t>));
...
{
    auto bool_1_v   = bio::meta::detail::min_viable_uint_v<0ull>;
    auto bool_2_v   = bio::meta::detail::min_viable_uint_v<1ull>;
    auto uint8_1_v  = bio::meta::detail::min_viable_uint_v<2ull>;
    auto uint8_2_v  = bio::meta::detail::min_viable_uint_v<0xFFull>;
    auto uint16_1_v = bio::meta::detail::min_viable_uint_v<0x100ull>;
    auto uint16_2_v = bio::meta::detail::min_viable_uint_v<0xFFFFull>;
    auto uint32_1_v = bio::meta::detail::min_viable_uint_v<0x10000ull>;
    auto uint32_2_v = bio::meta::detail::min_viable_uint_v<0xFFFFFFFFull>;
    auto uint64_1_v = bio::meta::detail::min_viable_uint_v<0x100000000ull>;
    auto uint64_2_v = bio::meta::detail::min_viable_uint_v<0xFFFFFFFFFFFFFFFFull>;
    ...
    EXPECT_TRUE((std::is_same_v<decltype(bool_1_v), uint8_t>));
    EXPECT_TRUE((std::is_same_v<decltype(bool_2_v), uint8_t>));
