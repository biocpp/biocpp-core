...
TEST(int_types_test, min_viable_uint_t)
{
    ...
    using uint32_2_t = bio::detail::min_viable_uint_t<0xFFFFFFFFull>;
    using uint64_1_t = bio::detail::min_viable_uint_t<0x100000000ull>;
    using uint64_2_t = bio::detail::min_viable_uint_t<0xFFFFFFFFFFFFFFFFull>;
...
TEST(int_types_test, min_viable_uint_v)
{
    ...
    auto uint32_2_v = bio::detail::min_viable_uint_v<0xFFFFFFFFull>;
    auto uint64_1_v = bio::detail::min_viable_uint_v<0x100000000ull>;
    auto uint64_2_v = bio::detail::min_viable_uint_v<0xFFFFFFFFFFFFFFFFull>;
