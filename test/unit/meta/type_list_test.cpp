...
{
    EXPECT_EQ((bio::detail::pack_traits::size<int, bool &, double const>), 3u);
}

TEST(pack_traits, count)
{
    EXPECT_EQ((bio::detail::pack_traits::count<int>), 0u);
    EXPECT_EQ((bio::detail::pack_traits::count<int, bool &, double const>), 0u);
    EXPECT_EQ((bio::detail::pack_traits::count<int, bool &, int, double const, int>), 2u);
}

TEST(pack_traits, find)
{
    EXPECT_EQ((bio::detail::pack_traits::find<int>), -1ll);
    EXPECT_EQ((bio::detail::pack_traits::find<int, bool &, double const>), -1ll);
    EXPECT_EQ((bio::detail::pack_traits::find<int, bool &, int, double const, int>), 1u);
}

TEST(pack_traits, find_if)
{
    EXPECT_EQ((bio::detail::pack_traits::find_if<std::is_integral>), -1ll);
    EXPECT_EQ((bio::detail::pack_traits::find_if<std::is_integral, float, double const>), -1ll);
    EXPECT_EQ((bio::detail::pack_traits::find_if<std::is_integral, float, int, double const, long>), 1ll);
}

TEST(pack_traits, contains)
{
    EXPECT_EQ((bio::detail::pack_traits::contains<int>), false);
    EXPECT_EQ((bio::detail::pack_traits::contains<int, bool &, double const>), false);
    EXPECT_EQ((bio::detail::pack_traits::contains<int, bool &, int, double const, int>), true);
}

TEST(pack_traits, at)
{
    EXPECT_TRUE(
      (std::is_same_v<bio::detail::pack_traits::at<2, int, bool &, double const, long, float>, double const>));
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::at<-2, int, bool &, double const, long, float>, long>));
}

TEST(pack_traits, front)
{
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::front<int, bool &, double const, long, float>, int>));
}

TEST(pack_traits, back)
{
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::back<int, bool &, double const, long, float>, float>));
}

TEST(pack_traits, drop_front)
{
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::drop_front<int, bool &, double const, long, float>,
                                bio::type_list<bool &, double const, long, float>>));
}

TEST(pack_traits, transform)
{
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::transform<std::ranges::range_value_t>, bio::type_list<>>));
    EXPECT_TRUE((
      std::is_same_v<bio::detail::pack_traits::transform<std::ranges::range_value_t, std::vector<int>, std::list<bool>>,
                     bio::type_list<int, bool>>));
    EXPECT_TRUE((std::is_same_v<
                 bio::detail::pack_traits::transform<std::ranges::range_reference_t, std::vector<int>, std::list<bool>>,
                 bio::type_list<int &, bool &>>));
}
...
{
    EXPECT_TRUE(
      (std::is_same_v<bio::detail::pack_traits::take<0, int, bool &, double const, long, float>, bio::type_list<>>));
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::take<3, int, bool &, double const, long, float>,
                                bio::type_list<int, bool &, double const>>));
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::take<5, int, bool &, double const, long, float>,
                                bio::type_list<int, bool &, double const, long, float>>));
}

TEST(pack_traits, drop)
{
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::drop<0, int, bool &, double const, long, float>,
                                bio::type_list<int, bool &, double const, long, float>>));
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::drop<3, int, bool &, double const, long, float>,
                                bio::type_list<long, float>>));
    EXPECT_TRUE(
      (std::is_same_v<bio::detail::pack_traits::drop<5, int, bool &, double const, long, float>, bio::type_list<>>));
}

TEST(pack_traits, take_last)
{
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::take_last<0, int, bool &, double const, long, float>,
                                bio::type_list<>>));
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::take_last<3, int, bool &, double const, long, float>,
                                bio::type_list<double const, long, float>>));
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::take_last<5, int, bool &, double const, long, float>,
                                bio::type_list<int, bool &, double const, long, float>>));
}

TEST(pack_traits, drop_last)
{
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::drop_last<0, int, bool &, double const, long, float>,
                                bio::type_list<int, bool &, double const, long, float>>));
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::drop_last<3, int, bool &, double const, long, float>,
                                bio::type_list<int, bool &>>));
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::drop_last<5, int, bool &, double const, long, float>,
                                bio::type_list<>>));
}

TEST(pack_traits, split_after)
{
    using split0 = bio::detail::pack_traits::split_after<0, int, bool &, double const, long, float>;
    ...
    using split3 = bio::detail::pack_traits::split_after<3, int, bool &, double const, long, float>;
    ...
    using split5 = bio::detail::pack_traits::split_after<5, int, bool &, double const, long, float>;
...
{
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::replace_at<double, 0, int, float, bool>,
                                bio::type_list<double, float, bool>>));
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::replace_at<double, 1, int, float, bool>,
                                bio::type_list<int, double, bool>>));
    EXPECT_TRUE((std::is_same_v<bio::detail::pack_traits::replace_at<double, 2, int, float, bool>,
