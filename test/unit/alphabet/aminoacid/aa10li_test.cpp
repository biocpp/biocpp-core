...
INSTANTIATE_TYPED_TEST_SUITE_P(aa10li, alphabet, bio::aa10li, );
INSTANTIATE_TYPED_TEST_SUITE_P(aa10li, semi_alphabet_test, bio::aa10li, );
INSTANTIATE_TYPED_TEST_SUITE_P(aa10li, alphabet_constexpr, bio::aa10li, );
INSTANTIATE_TYPED_TEST_SUITE_P(aa10li, semi_alphabet_constexpr, bio::aa10li, );
INSTANTIATE_TYPED_TEST_SUITE_P(aa10li, aminoacid, bio::aa10li, );
...
TEST(aa10li, assign_char)
{
    ...
    std::vector<bio::aa10li> alphabets
    {
...
{
    EXPECT_EQ(bio::to_char('A'_aa10li), 'A');
    EXPECT_EQ(bio::to_char('B'_aa10li), 'B');
    EXPECT_EQ(bio::to_char('C'_aa10li), 'C');
    EXPECT_EQ(bio::to_char('F'_aa10li), 'F');
    EXPECT_EQ(bio::to_char('G'_aa10li), 'G');
    EXPECT_EQ(bio::to_char('H'_aa10li), 'H');
    EXPECT_EQ(bio::to_char('I'_aa10li), 'I');
    EXPECT_EQ(bio::to_char('J'_aa10li), 'J');
    EXPECT_EQ(bio::to_char('K'_aa10li), 'K');
    EXPECT_EQ(bio::to_char('P'_aa10li), 'P');

    EXPECT_EQ(bio::to_char('*'_aa10li), 'F');
    EXPECT_EQ(bio::to_char('!'_aa10li), 'A');
}

TEST(literals, vector)
{
    bio::aa10li_vector v20;
    v20.resize(5, 'D'_aa10li);
    EXPECT_EQ(v20, "BBBBB"_aa10li);

    std::vector<bio::aa10li> w20{'A'_aa10li, 'D'_aa10li, 'N'_aa10li, 'O'_aa10li, 'U'_aa10li, 'X'_aa10li, 'R'_aa10li,
...
TEST(aa10li, char_is_valid)
{
    ...
    for (char c : std::views::iota(std::numeric_limits<char>::min(), std::numeric_limits<char>::max()))
    {
        ...
        EXPECT_EQ(bio::aa10li::char_is_valid(c), expect);
    }
}
