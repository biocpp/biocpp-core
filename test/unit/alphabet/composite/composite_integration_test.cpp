...
TEST(composite, custom_constructors)
{
    ...
    bio::qualified<bio::aa27, bio::phred63> t20{'K'_aa27, bio::phred63{}};
    bio::qualified<bio::aa27, bio::phred63> t21{'K'_aa27};
    bio::qualified<bio::aa27, bio::phred63> t22{'$'_phred63};
    bio::qualified<bio::aa27, bio::phred63> t23{'$'_phred42};
    ...
    qualified_gapped_dna_phred42 t34{bio::gap{}};
    qualified_gapped_dna_phred42 t35{bio::gapped<bio::dna4>('C'_dna4)};
    qualified_gapped_dna_phred42 t36{bio::gapped<bio::dna4>(bio::gap{})};
    qualified_gapped_dna_phred42 t37{bio::gap{}, '$'_phred42};
    ...
    qualified_qualified_gapped_dna_phred42_phred42 t54{bio::gap{}};
    qualified_qualified_gapped_dna_phred42_phred42 t55{bio::gapped<bio::dna4>('C'_dna4)};
    qualified_qualified_gapped_dna_phred42_phred42 t56{bio::gapped<bio::dna4>(bio::gap{})};
...
TEST(composite_constexpr, custom_constructor)
{
    ...
    constexpr bio::qualified<bio::aa27, bio::phred63> t21{'K'_aa27};
    constexpr bio::qualified<bio::aa27, bio::phred63> t22{'$'_phred63};
    constexpr bio::qualified<bio::aa27, bio::phred63> t23{'$'_phred42};
    ...
    constexpr qualified_gapped_dna_phred42 t34{bio::gap{}};
    constexpr qualified_gapped_dna_phred42 t35{bio::gapped<bio::dna4>('C'_dna4)};
    constexpr qualified_gapped_dna_phred42 t36{bio::gapped<bio::dna4>(bio::gap{})};
    constexpr qualified_gapped_dna_phred42 t37{bio::gap{}, '$'_phred42};
    ...
    constexpr qualified_qualified_gapped_dna_phred42_phred42 t54{bio::gap{}};
    constexpr qualified_qualified_gapped_dna_phred42_phred42 t55{bio::gapped<bio::dna4>('C'_dna4)};
    constexpr qualified_qualified_gapped_dna_phred42_phred42 t56{bio::gapped<bio::dna4>(bio::gap{})};
...
TEST(composite, custom_assignment)
{
    ...
    bio::qualified<bio::aa27, bio::phred63> t20{'K'_aa27, bio::phred63{}};
    bio::qualified<bio::aa27, bio::phred63> t21{};
    bio::qualified<bio::aa27, bio::phred63> t22{'K'_aa27, '$'_phred63};
    t21 = 'K'_aa27;
    EXPECT_EQ(t20, t21);
    t21 = '$'_phred63;
    EXPECT_EQ(t21, t22);
    ...
    qualified_gapped_dna_phred42 t34{bio::gap{}, '$'_phred42};
    t31 = 'C'_dna4;
    EXPECT_EQ(t31, t32);
    t31 = 'C'_rna4;
    EXPECT_EQ(t31, t32);
    ...
    t31 = bio::gap{};
    EXPECT_EQ(t31, t34);
    t31 = bio::gapped<bio::dna4>('C'_dna4);
    EXPECT_EQ(t31, t33);
    t31 = bio::gapped<bio::dna4>(bio::gap{});
    EXPECT_EQ(t31, t34);
    ...
    EXPECT_EQ(t41, t42);
    t41 = '$'_phred42;
    // EXPECT_EQ(t41, t43); should work intuitively but does not because on assignment the bio::qualified object is defaulted
    t41 = bio::gap{};
    EXPECT_EQ(t41, t44);
    ...
    t51 = bio::gap{};
    EXPECT_EQ(t51, t54);
    t51 = bio::gapped<bio::dna4>('C'_dna4);
    EXPECT_EQ(t51, t53);
    t51 = bio::gapped<bio::dna4>(bio::gap{});
    EXPECT_EQ(t51, t54);
...
TEST(composite, custom_comparison)
{
    ...
    bio::qualified<bio::aa27, bio::phred63> t21{'K'_aa27, '$'_phred63};
    ...
    EXPECT_NE(t31, bio::gap{});
    EXPECT_EQ(t31, bio::gapped<bio::dna4>('C'_dna4));
    EXPECT_LT(t31, 'G'_dna4); // *
    EXPECT_LT(t31, 'G'_rna4); // *
    EXPECT_LT(t31, '%'_phred42);
    EXPECT_LT(t31, bio::gap{}); // *
    EXPECT_LT(t31, bio::gapped<bio::dna4>('G'_dna4));

    EXPECT_EQ('C'_dna4, t31);
    EXPECT_EQ('C'_rna4, t31);
    EXPECT_EQ('$'_phred42, t31);
    EXPECT_NE(bio::gap{}, t31);
    EXPECT_EQ(bio::gapped<bio::dna4>('C'_dna4), t31);
