...
class detail_variant : public bio::alphabet::variant<alphabet_types...>
{
public:
    using bio::alphabet::variant<alphabet_types...>::partial_sum_sizes;
    using bio::alphabet::variant<alphabet_types...>::rank_to_char;
    using bio::alphabet::variant<alphabet_types...>::char_to_rank;
    using bio::alphabet::variant<alphabet_types...>::first_valid_char_table;
};

TEST(variant_detail_test, partial_sum_sizes)
{
    constexpr std::array partial_sum2 = detail_variant<bio::alphabet::dna4, bio::alphabet::gap>::partial_sum_sizes;
    ...
    constexpr std::array partial_sum3 =
      detail_variant<bio::alphabet::dna4, bio::alphabet::gap, bio::alphabet::dna5>::partial_sum_sizes;
    ...
    constexpr std::array partial_sum4 =
      detail_variant<bio::alphabet::dna5, bio::alphabet::gap, bio::alphabet::dna4>::partial_sum_sizes;
...
TEST(variant_detail_test, rank_to_char_table)
{
    constexpr std::array rank_to_char2 = detail_variant<bio::alphabet::dna4, bio::alphabet::gap>::rank_to_char;
    ...
    constexpr std::array rank_to_char3 =
      detail_variant<bio::alphabet::dna4, bio::alphabet::gap, bio::alphabet::dna5>::rank_to_char;
    ...
    constexpr std::array rank_to_char4 =
      detail_variant<bio::alphabet::dna5, bio::alphabet::gap, bio::alphabet::dna4>::rank_to_char;
...
TEST(variant_detail_test, char_to_rank_table)
{
    constexpr std::array char_to_rank2 = detail_variant<bio::alphabet::dna4, bio::alphabet::gap>::char_to_rank;
    ...
    constexpr std::array char_to_rank3 =
      detail_variant<bio::alphabet::dna4, bio::alphabet::gap, bio::alphabet::dna5>::char_to_rank;
    ...
    constexpr std::array char_to_rank4 =
      detail_variant<bio::alphabet::dna5, bio::alphabet::gap, bio::alphabet::dna4>::char_to_rank;
...
TEST(variant_detail_test, first_valid_char_table)
{
    constexpr std::array first_valid_char_table2 =
      detail_variant<bio::alphabet::dna4, bio::alphabet::gap>::first_valid_char_table;
    ...
    constexpr std::array first_valid_char_table3 =
      detail_variant<bio::alphabet::dna4, bio::alphabet::gap, bio::alphabet::dna5>::first_valid_char_table;
    ...
    constexpr std::array first_valid_char_table4 =
      detail_variant<bio::alphabet::dna5, bio::alphabet::gap, bio::alphabet::dna4>::first_valid_char_table;
