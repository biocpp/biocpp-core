...
TEST(alphabet_variant_detail_test, partial_sum_sizes)
{
    ...
    constexpr std::array partial_sum3 = detail_alphabet_variant<bio::dna4, bio::gap, bio::dna5>::partial_sum_sizes;
    ...
    constexpr std::array partial_sum4 = detail_alphabet_variant<bio::dna5, bio::gap, bio::dna4>::partial_sum_sizes;
...
TEST(alphabet_variant_detail_test, rank_to_char_table)
{
    ...
    constexpr std::array rank_to_char3 = detail_alphabet_variant<bio::dna4, bio::gap, bio::dna5>::rank_to_char;
    ...
    constexpr std::array rank_to_char4 = detail_alphabet_variant<bio::dna5, bio::gap, bio::dna4>::rank_to_char;
...
TEST(alphabet_variant_detail_test, char_to_rank_table)
{
    ...
    constexpr std::array char_to_rank3 = detail_alphabet_variant<bio::dna4, bio::gap, bio::dna5>::char_to_rank;
    ...
    constexpr std::array char_to_rank4 = detail_alphabet_variant<bio::dna5, bio::gap, bio::dna4>::char_to_rank;
...
{
    constexpr std::array first_valid_char_table2 = detail_alphabet_variant<bio::dna4, bio::gap>::first_valid_char_table;
    ...
    constexpr std::array first_valid_char_table3 =
      detail_alphabet_variant<bio::dna4, bio::gap, bio::dna5>::first_valid_char_table;
    ...
    constexpr std::array first_valid_char_table4 =
      detail_alphabet_variant<bio::dna5, bio::gap, bio::dna4>::first_valid_char_table;
