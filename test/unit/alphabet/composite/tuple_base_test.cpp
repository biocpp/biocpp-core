...
public:
    ...
    // test_composite<bio::alphabet::dna4, bio::alphabet::dna5>
    // -------------------------------------------------------------------------
    bio::alphabet::dna4 value_1() { return 'G'_dna4; }
    bio::alphabet::rna4 assignable_to_value_1() { return 'G'_rna4; }
    bio::alphabet::dna5 value_2() { return 'G'_dna5; }
    bio::alphabet::rna5 assignable_to_value_2() { return 'G'_rna5; }
    auto                values_to_cmp()
    {
