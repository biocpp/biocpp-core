...
TEST(general, construction)
{
    // char
    char                  chr{'A'};
    [[maybe_unused]] auto v = bio::ranges::views::repeat_n(chr, 4);
    ...
    [[maybe_unused]] auto v_const = bio::ranges::views::repeat_n(chr_const, 20);
...
{
    char                  chr{'A'};
    [[maybe_unused]] auto v = bio::ranges::views::repeat_n(chr, 10);
