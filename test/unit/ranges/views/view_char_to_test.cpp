...
TEST(view_char_to, basic)
{
    ...
    // pipe notation
    bio::dna5_vector v = vec | bio::ranges::views::char_to<bio::dna5> | bio::ranges::views::to<std::vector>();
    EXPECT_EQ(cmp, v);

    // function notation
    bio::dna5_vector v2(bio::ranges::views::char_to<bio::dna5>(vec) | bio::ranges::views::to<std::vector>());
    EXPECT_EQ(cmp, v2);

    // combinability
    bio::dna5_vector cmp2{"ATAGTTTCA"_dna5};
    bio::dna5_vector v3 =
      vec | bio::ranges::views::char_to<bio::dna5> | std::views::reverse | bio::ranges::views::to<std::vector>();
    EXPECT_EQ(cmp2, v3);
}
...
TEST(view_char_to, deep_view)
{
    ...
    std::vector<bio::dna5_vector> v =
      foo | bio::ranges::views::char_to<bio::dna5> | bio::ranges::views::to<std::vector<bio::dna5_vector>>();
...
TEST(view_char_to, concepts)
{
    ...
    auto v1 = vec | bio::ranges::views::char_to<bio::dna5>;
