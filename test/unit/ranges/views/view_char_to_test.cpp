...
TEST(view_char_to, basic)
{
    ...
    bio::dna5_vector v3 = vec | bio::views::char_to<bio::dna5> | std::views::reverse | bio::views::to<std::vector>();
    EXPECT_EQ(cmp2, v3);
}
...
TEST(view_char_to, deep_view)
{
    ...
    std::vector<bio::dna5_vector> v =
      foo | bio::views::char_to<bio::dna5> | bio::views::to<std::vector<bio::dna5_vector>>();
