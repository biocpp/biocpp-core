...
struct fmt::formatter<alph_t> : fmt::formatter<bio::alphabet_char_t<alph_t>, bio::alphabet_char_t<alph_t>>
{
...
concept bio_range = std::ranges::forward_range<rng_t> &&
  (!std::integral<std::ranges::range_value_t<rng_t>>)&&bio::alphabet<std::ranges::range_reference_t<rng_t>>;
