 ...
 * don't care positions, but does not want to use the bio::dna15 **N** or
 * bio::aa27 **X** because of loss of information. It will instead mark the specified characters as masked,
 ...
 * This alphabet in itself is not useful to users directly, but instead the composite bio::masked may be used to
