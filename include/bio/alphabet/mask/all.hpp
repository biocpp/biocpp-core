 ...
 * don't care positions, but does not want to use the bio::alphabet::dna15 **N** or
 * bio::alphabet::aa27 **X** because of loss of information. It will instead mark the specified characters as masked,
 ...
 * This alphabet in itself is not useful to users directly, but instead the composite bio::alphabet::masked may be used to
