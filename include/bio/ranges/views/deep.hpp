 ...
 *
 * \include test/snippet/ranges/views/deep_no_param.cpp
 *
 * Wrapping an adaptor that takes parameters:
 *
 * \include test/snippet/ranges/views/deep_with_param.cpp
 *
 ...
 *
 * \include test/snippet/ranges/views/deep_pass_ref.cpp
 *
 * Wrapping an adaptor including its arguments:
 *
 * \include test/snippet/ranges/views/deep_wrap_args.cpp
